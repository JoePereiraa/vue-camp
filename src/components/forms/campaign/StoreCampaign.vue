    ...
    <form @submit="onSubmit">
        <GridLayout class="gap-5">
                            ...
                            <GridLayout class="gap-3">
                                ...
                                <ColumnLayout class="flex flex-col gap-2 col-span-5!">
                                    ...
                                    <FlexLayout class="flex-col gap-1!">
                                        ...
                                        <RequiredForm v-if="e.instacia_id" :message="e.instacia_id"/>
                                    </FlexLayout>
                                </ColumnLayout>
                            </GridLayout>
                        </CardForm>
                    ...
                    <ColumnLayout class="col-span-12">
                        <CardForm>
                            ...
                            <FlexLayout class="flex-col">
                                ...
                                <div v-if="overflow > 0" role="alert" class="alert alert-warning alert-dash relative">
                                    <FlexLayout class="flex-col gap-2!">
            ...
            <ColumnLayout class="col-span-3!">
                <VueJsonPretty :root-path="path" :data="campaing" showIcon showLineNumber/>
            </ColumnLayout>
        </GridLayout>
